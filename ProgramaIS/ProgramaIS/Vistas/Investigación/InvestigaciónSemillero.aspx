<%@ Page Title="" Language="C#" MasterPageFile="~/Vistas/Plataforma/PrincipalWM.Master" AutoEventWireup="true" CodeBehind="InvestigaciónSemillero.aspx.cs" Inherits="ProgramaIS.Vistas.Investigación.InvestigaciónSemillero" %>
...
<div class="col-md-12">
                        <div class="panel panel-info">
                            <div class="panel-heading">Semilleros de Investigación</div>
                                ...
                                <div class="panel-body">
                                    <form action="#" class="form-horizontal form-bordered">
                                        <div class="form-body">
                                         ...
                                         <div class="form-group">
                                                <label class="control-label col-md-3">Lider</label>
                                                <div class="col-md-7">
                                                    <input type="text" placeholder="" class="form-control">
